  ...
  return (
    <div className="font-roboto-condensed" style={{ lineHeight: '1.5' }}>
      ...
      <p>
        ...
        todas as instruções das versões mais antigas.
        A arquitetura original foi implementada com um pipeline de três estágios,
      ...
      <p>
        ...
        todos os processadores de todas as versões da arquitetura são compatíveis.
        ...
        simétrica; contudo, os registradores R14 e R15 têm funções especiais.Conjunto de
        registradores
        ...
        O estágio de execução do pipeline inclui uma Unidade Lógica e Aritmética
        ...
        pela ALU como resultado da execução da instrução.
        O multiplicador permite calcular o produto entre um número de 32 bits e
        ...
        utilizado em conjunto com a operação realizada pela ALU.
        Os flags de estado do processador são armazenados em um registrador
      ...
      <p>
        ...
        Operacional com a instrução swi).
        Instâncias dedicadas de alguns registradores são exclusivas de cada modo,
      ...
      <p>
        ...
        Observe que o registrador R13 também é preservado durante as mudanças
        ...
        automatizando a definição de pilhas separadas para cada modo.
        Os registradores do ARM podem conter valores de 32 bits (“words”), cujo
        ...
        7 (no caso de bytes com sinal) até o bit 31 do registrador de destino.
        A memória é sempre organizada em bytes (cada endereço contém um byte)
      ...
      <p>
        ...
        endereços menores). Após o reset, a ordenação padrão é little endian.
        Em contraste com as arquiteturas RISC tradicionais, com o objetivo de
        ...
        registradores em sequência na memória (load multiple e store multiple).
        Todas essas operações normalmente levam vários ciclos de máquina para serem
        executadas.
        Observe que apesar de existirem instruções especiais para a troca de
