...
const AcessoMemoria = () => {
    return (
        <div className="font-roboto-condensed" style={{ lineHeight: '1.5' }}>
            ...
            <p className="espaco-paragrafo">O modo pré-indexado (bit “P” da instrução igual a “um”) calcula o
                ...
                na operação de memória.
                A direção da indexação é definida pelo valor do bit “U”: caso seja “1” (up),
                ...
                11) é sempre positivo.
                Finalmente, o bit “B” da instrução permite especificar o tamanho da
                ...
                origem são transferidos à memória.
                Convencionam-se os formatos das instruções load e store com offset
            ...
            <p className="espaco-paragrafo">No caso das instruções half word, o endereço efetivo (calculado usando o
                ...
                instruções store.
                O formato das instruções half word usando um offset imediato é
            ...
            <p className="espaco-paragrafo">
                ...
                restaurado.
                Convencionam-se os formatos das instruções load e store multiple para
